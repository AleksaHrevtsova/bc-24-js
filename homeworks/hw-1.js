// ===================== HOMEWORK ========================== //
// == task-1 == // ШАБЛОННАЯ СТРОКА И ИНТЕРПОЛЯЦИЯ
...
// == task-4 == // ВЕТВЛЕНИЕ IF...ELSE С ВЛОЖЕННОСТЬЮ
